    ...
    <AppLayout currentStep={1}>
      <div className="flex flex-col h-screen">
        ...
        <div className="flex-1 overflow-auto px-8 py-6">
                        ...
                        <tr key={item.id} className="border-b hover:bg-table-hover transition-colors group">
                          ...
                          <td className="py-2 px-3 text-center">
                            <button
                              ...
                              onClick={() => {
                                const updated = data.siCommon.filter((_, i) => i !== idx);
                                setData((prev) => ({ ...prev, siCommon: updated }));
                              }}
                ...
                <Button
                  ...
                  onClick={() => {
                    setData((prev) => ({
                      ...
                      siCommon: [
                        ...prev.siCommon,
                        { id: `SI-NEW-${Date.now()}`, task: '신규 작업', minMM: 0, maxMM: 0, note: '' },
                      ],
                    }));
                  }}
                >
                        ...
                        <tr key={item.id} className="border-b hover:bg-table-hover transition-colors group">
                          ...
                          <td className="py-2 px-3 text-left text-muted-foreground">
                            <EditableTextCell
                              ...
                              onChange={(v) => {
                                const updated = [...data.overhead];
                                updated[idx] = { ...updated[idx], basis: v };
                                setData((prev) => ({ ...prev, overhead: updated }));
                              }}
                            />
                          </td>
                          ...
                          <td className="py-2 px-3 text-center">
                            <button
                              className="opacity-60 hover:opacity-100 transition-opacity text-destructive"
                              onClick={() => {
                                const updated = data.overhead.filter((_, i) => i !== idx);
                                setData((prev) => ({ ...prev, overhead: updated }));
                              }}
          ...
          {activeTab === 'wbs' && (
            <WbsTab
              phases={data.wbsPhases}
              projectManagement={data.wbsProjectManagement}
              onPhasesChange={(wbsPhases) => setData((prev) => ({ ...prev, wbsPhases }))}
              onProjectManagementChange={(wbsProjectManagement) => setData((prev) => ({ ...prev, wbsProjectManagement }))}
            />
          )}
        </div>
